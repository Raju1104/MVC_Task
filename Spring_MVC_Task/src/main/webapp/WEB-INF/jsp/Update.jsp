		...
		<div class="content">
			<form action="update">
				<div class="user-details">
					<div class="input-box">
						<span class="details">Id</span> <input type="text"
					...
					<div class="input-box">
						<span class="details">Student Age</span> <input type="text"
					...
					<div class="input-box">
						<span class="details">Mobile Number</span> <input type="text"
							placeholder="Mobile Number" name="mobile" maxlength="10" required>
					</div>
					<div class="input-box">
					...
					<div class="input-box">
						<span class="details">Admission Date</span> <input type="date"
							placeholder="Admission Date" name="admission" required>
					</div>
